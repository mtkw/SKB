...
@SessionScoped
@Named
public class ConditionsChoicePBOLD implements Serializable {
...
//    private List<InsuranceConditionsDTO> conditionsItem;
...
//        String param2 = (String) requestMap.get("id_insurance");
        ...
        //Pierwszy Przykład z SelectItem
        conditionsItem = new ArrayList<SelectItem>(insurance.getRowCount());
        
        //Drugi Przykład z obiektami DTO
//        conditionsItem = new ArrayList<InsuranceConditionsDTO>(insurance.getRowCount());
        ...
        for (InsuranceConditionsDTO row : insurance) {
            conditionsItem.add(new SelectItem(row, row.toString()));
        }
        return "conditions";
    }
